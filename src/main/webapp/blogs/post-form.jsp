            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <div class="my-5">
                    ...
                    <form id="contactForm" action="post.do" method="post">
                        ...
                        <div class="form-floating">
                            <input class="form-control" name="author" id="author" value="${sessionScope.author}"  type="text" placeholder="Enter your name..." data-sb-validations="required" readonly />
                            <label for="author">Name</label>
                            <div class="invalid-feedback" data-sb-feedback="name:required">A name is required.</div>
                        </div>
                        <div class="form-floating">
                            <input class="form-control" name="email" id="email" value="${sessionScope.logined}" type="email" placeholder="Enter your email..." data-sb-validations="required,email" readonly />
